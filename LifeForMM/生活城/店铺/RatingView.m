...
-(void)layoutSubviews
{
    ...
    for (int i = 0; i<5; i++) {
        ...
        gayStart.frame = CGRectMake(35*i*MCscale, 0, 30*MCscale, 30*MCscale);
        redStart.frame = CGRectMake(35*i*MCscale, 0, 30*MCscale, 30*MCscale);
    }
    CGFloat redWidth  = 15*MCscale;
    if (_ratingScore<10*MCscale) {
        redWidth = 15*MCscale;
    }
