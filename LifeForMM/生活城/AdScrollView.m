...
- (void)setImageNameArray:(NSArray *)imageNameArray
{
    if (imageNameArray.count > 0 ) {
        ...
        [_leftImageView sd_setImageWithURL:_imageNameArray[3] placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
        [_centerImageView sd_setImageWithURL:_imageNameArray[0] placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
        [_rightImageView sd_setImageWithURL:_imageNameArray[1] placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
    }
    else{
        aryStyle = 1;
        NSArray *arry =@[@"A轮播1",@"A轮播1",@"A轮播1",@"A轮播1"];
        _imageNameArray = @[];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (aryStyle == 0) {
        [_leftImageView sd_setImageWithURL:_imageNameArray[(currentImage-2)%_imageNameArray.count] placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
        [_centerImageView sd_setImageWithURL:_imageNameArray[(currentImage-1)%_imageNameArray.count]  placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
        [_rightImageView sd_setImageWithURL:_imageNameArray[(currentImage)%_imageNameArray.count] placeholderImage:[UIImage imageNamed:@"A轮播1"] options:SDWebImageRefreshCached];
    }
    else{
